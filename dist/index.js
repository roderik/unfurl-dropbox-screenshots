...
module.exports = (function (e, t) {
  ...
  168: function (e) {
    ...
    e.exports = (e) => {
      ...
      const i = e.stdio || [];
      if (!Array.isArray(i)) {
        throw new TypeError(`Expected \`stdio\` to be of type \`string\` or \`Array\`, got \`${typeof i}\``);
      }
      const n = [];
  ...
  215: function (e) {
    e.exports = {
      ...
      _phantomChildren: { '@octokit/types': '2.5.1', deprecation: '2.3.1', once: '1.4.0' },
      _requested: {
        type: 'range',
        registry: true,
      ...
      _where: '/Users/roderik/Development/unfurl-dropbox-screenshots/node_modules/@actions/github',
  ...
  280: function (e, t) {
    ...
    Comparator.prototype.parse = function (e) {
      var t = this.options.loose ? o[$] : o[N];
      var r = e.match(t);
      if (!r) {
  ...
  325: function (e, t, r) {
    ...
    function run() {
      return i(this, void 0, void 0, function* () {
        try {
          const e = getArgs();
          const t = new o.GitHub(e.repoToken);
          yield processIssues(t);
        } catch (e) {
          s.error(e.toString());
    ...
    function processIssues(e) {
      return i(this, void 0, void 0, function* () {
        const t = yield e.issues.listForRepo({ owner: o.context.repo.owner, repo: o.context.repo.repo, state: 'open' });
        for (const r of t.data.values()) {
          s.debug(`found issue: ${r.title} last updated ${r.updated_at}`);
          const t = urlReplace(r.body);
          if (r.body !== t) {
            yield e.issues.update({
              owner: o.context.repo.owner,
              repo: o.context.repo.repo,
              issue_number: r.number,
              body: imageReplace(urlReplace(r.body)),
            });
          }
        }
      });
    ...
    function urlReplace(e) {
      const t = /((?<!\+)(?:https?(?::\/\/))(?:www\.)?(?:[a-zA-Z\d-_.]+(?:(?:\.|@)[a-zA-Z\d]{2,})|localhost)(?:(?:[-a-zA-Z\d:%_+.~#!?&//=@]*)(?:[,](?![\s]))*)*)/g;
      return e.replace(t, (e) => {
        const t = new a.URL(e);
        if (t.hostname.includes('dropbox.com')) {
          t.search = 'raw=1';
          return t.toString();
        }
        return e;
    ...
    function getArgs() {
      return { repoToken: s.getInput('repo-token', { required: true }) };
    }
    run().catch((e) => {
      s.error(e);
      s.setFailed(e.message);
      ...
      Object.keys(r).forEach((e) => {
        ...
        l.forEach((r, n) => {
          ...
          if (a === 'integer') {
            ...
            r = parseInt(r, 10);
            if (isNaN(r)) {
              throw new i(`Invalid value for parameter '${l}': ${JSON.stringify(e)} is NaN`, 400, { request: t });
            }
          }
          ...
          if (a === 'object' && typeof r === 'string') {
            try {
              ...
              throw new i(`JSON parse error of value for parameter '${l}': ${JSON.stringify(r)}`, 400, { request: t });
            }
          }
          s(t, o.mapTo || l, r);
        });
  ...
  349: function (e, t, r) {
    ...
    function authenticationRequestError(e, t, r) {
      ...
      if (t.status === 401 && n && t.request && t.request.headers['x-github-otp']) {
        throw new i('Invalid one-time password for two-factor authentication', 401, { headers: t.headers, request: r });
      }
      if (typeof e.auth.on2fa !== 'function') {
        throw new i(
          '2FA required, but options.on2fa is not a function. See https://github.com/octokit/rest.js#authentication',
      ...
      if (!p) {
        if (e.mediaType.format) {
          i.accept = i.accept
            .split(/,/)
            .map((t) =>
              t.replace(/application\/vnd(\.\w+)(\.v3)?(\.\w+)?(\+json)?$/, `application/vnd$1$2.${e.mediaType.format}`)
            )
            .join(',');
        }
  ...
  431: function (e, t, r) {
    ...
    function escapeData(e) {
      return (e || '').replace(/%/g, '%25').replace(/\r/g, '%0D').replace(/\n/g, '%0A');
    }
  ...
  454: function (e, t, r) {
    ...
    class Request {
      constructor(e) {
        ...
        this[w] = { method: i, redirect: t.redirect || e.redirect || 'follow', headers: s, parsedURL: r, signal: o };
    ...
    class RequestError extends Error {
      constructor(e, t, r) {
        ...
        Object.defineProperty(this, 'code', {
          get() {
            s(new i.Deprecation('[@octokit/request-error] `error.code` is deprecated, use `error.status`.'));
            return t;
          },
        });
  ...
  489: function (e, t, r) {
    ...
    function resolveCommandAttempt(e, t) {
      ...
      let a;
      try {
        a = n.sync(e.command, { path: (e.options.env || process.env)[s], pathExt: t ? i.delimiter : undefined });
      } catch (e) {
      } finally {
        process.chdir(r);
      }
  ...
  674: function (e, t, r) {
    ...
    function authenticate(e, t) {
      s(
        e.octokit.log,
        new i('[@octokit/rest] octokit.authenticate() is deprecated. Use "auth" constructor option instead.')
      );
      if (!t) {
        e.auth = false;
        return;
      ...
      repos: {
        ...
        listForOrg: {
          ...
          params: {
            ...
            per_page: { type: 'integer' },
            sort: { enum: ['created', 'updated', 'pushed', 'full_name'], type: 'string' },
            type: { enum: ['all', 'public', 'private', 'forks', 'sources', 'member', 'internal'], type: 'string' },
          },
          url: '/orgs/:org/repos',
        },
        listForUser: {
      ...
      const s = (s) => {
        ...
        Object.keys(s).forEach((r) => {
          if (t.params[r] && t.params[r].deprecated) {
            ...
            e.log.warn(
              new i.Deprecation(`[@octokit/rest] "${r}" parameter is deprecated for "${n}". Use "${o}" instead`)
            );
            if (!(o in s)) {
              s[o] = s[r];
            }
  ...
  883: function (e) {
    ...
    var G = S ? S.prototype : undefined,
      A = G ? G.toString : undefined;
    function Hash(e) {
      var t = -1,
        r = e ? e.length : 0;
      this.clear();
